...
SIM_SCRIPT_GEN_DIR=$DESIGN_ROOT_DIR/sim_setup_baseline_a55
...
vlogan -sverilog $DESIGN_ROOT_DIR/baseline_a55.sv
vlogan -sverilog $DESIGN_ROOT_DIR/sim/baseline_a55_tb.sv
#
