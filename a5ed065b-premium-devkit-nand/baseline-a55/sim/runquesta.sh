...
vsim -c -do "
	...
	vlog -sv $DESIGN_ROOT_DIR/ip/shell_subsys/user_rst_clkgate_0/sim/user_rst_clkgate_0.v; 
	vlog $DESIGN_ROOT_DIR/ip/shell_subsys/user_rst_clkgate_0/altera_s10_user_rst_clkgate_1949/sim/altera_s10_user_rst_clkgate.sv; 
