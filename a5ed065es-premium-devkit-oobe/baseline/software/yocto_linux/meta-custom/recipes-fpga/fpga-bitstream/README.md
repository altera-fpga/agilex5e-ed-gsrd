...
- Copy fpga bitstream i.e ```top.core.rbf``` at ```meta-custom/recipes-fpga/fpga-bitstream/files/```
...
FPGA options
 ...
 (top.core.rbf) Core RBF configuration bitstream filename
```
...
- During the build, the top.core.rbf file is installed to:
