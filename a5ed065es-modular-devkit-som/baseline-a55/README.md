# HPS Baseline-A55 System Example Design for Modular Development Kit for Agilex 5 FPGA E-Series 065B Modular Development Kit (ES)
...
- **Design Package**: a5ed065es-modular-devkit-som-baseline-a55.zip
...
**URL**: https://github.com/altera-fpga/agilex5e-ed-gsrd/blob/main/a5ed065es-modular-devkit-som/baseline-a55/README.md

## GHRD Overview
![Block Diagram Baseline2 GHRD Overview](../../images/oobe-baseline-overview.png)
...
#### Notes
- There are 2 user DIP switch inputs, 2 user push-button inputs and 1 LED outputs that is connected to fpga pins on Agilex 5 FPGA E-Series 065B Modular Development Kit.
