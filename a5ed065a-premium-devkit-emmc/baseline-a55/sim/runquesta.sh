...
vsim -c -do "
	...
	vlog -sv $DESIGN_ROOT_DIR/baseline_a55.sv;
	vlog -sv ./hps_h2f_pkg.sv;
	vlog -sv ./hps_h2f_lw_pkg.sv;
	vlog -sv -timescale 1ps/1ps ./baseline_a55_tb.sv -L altera_lnsim_ver;
	vlog $DESIGN_ROOT_DIR/ip/shell_subsys/sys_pll/sim/sys_pll.v;
	vlog $DESIGN_ROOT_DIR/ip/shell_subsys/user_rst_clkgate_0/sim/user_rst_clkgate_0.v; 
	vlog -sv $DESIGN_ROOT_DIR/ip/shell_subsys/user_rst_clkgate_0/altera_s10_user_rst_clkgate_1949/sim/altera_s10_user_rst_clkgate.sv; 
