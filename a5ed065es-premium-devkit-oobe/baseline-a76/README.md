# HPS Baseline-A76 System Example Design with HPS Expansion Board for Agilex 5 FPGA E-Series 065B Premium Development Kit
...
```bash
make baseline-a76-install-core-rbf
```
...
```bash
make output_files/prep-baseline_a76.done
```
