...
`define h2f_bfm_m dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.sundancemesa_hps_inst.h2f_bfm_gen.h2f_axi4_master_inst
`define lwh2f_bfm_m dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.sundancemesa_hps_inst.lwh2f_bfm_gen.lwh2f_axi4_master_inst
...
module testbench ();
    ...
    // Provides a weak pull-up for mdio port
    wire fpga_emac1_mdio;
    pullup (fpga_emac1_mdio);
    // Test flag
    bit h2f_pass = 1;
    bit lwh2f_pass = 1;
    bit test_pass = 1;
    ...
    tsn_cfg2 dut (
        ...
        .fpga_rgmii_tx_ctl              (),
        .fpga_emac1_mdc                 (),
        .fpga_emac1_mdio                (fpga_emac1_mdio),
        // External FPGA Reset
    ...
    initial begin
        force dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.sundancemesa_hps_inst.h2f_bfm_gen.h2f_axi4_master_inst.rstn = !dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.hps2fpga_rst;
        force dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.sundancemesa_hps_inst.lwh2f_bfm_gen.lwh2f_axi4_master_inst.rstn = !dut.u_tsn_cfg2_top.u_shell_subsys.u_hps_subsys.u_agilex_hps.intel_agilex_5_soc_inst.sm_hps.hps2fpga_rst;
    end
