...
$(YOCTO_MAINLINE_QSPI_IMAGE_DIR)/console-image-minimal-$(KAS_MACHINE).rootfs_nor.ubifs \
...
output_files/%_yocto_linux_mainline_qspi.sof : output_files/%.sof $(YOCTO_MAINLINE_QSPI_IMAGE_DIR)/console-image-minimal-$(KAS_MACHINE).rootfs_nor.ubifs
...
$(SW_YOCTO_LINUX_MAINLINE_QSPI_TARGET)-build-sw: $(YOCTO_MAINLINE_QSPI_IMAGE_DIR)/console-image-minimal-$(KAS_MACHINE).rootfs_nor.ubifs

.PHONY: $(SW_YOCTO_LINUX_MAINLINE_QSPI_TARGET)-install-sw
$(SW_YOCTO_LINUX_MAINLINE_QSPI_TARGET)-install-sw : \
	$(INSTALL_ROOT_BINARIES)/software/yocto_linux_mainline_qspi/console-image-minimal-$(KAS_MACHINE).rootfs_nor.ubifs \
	$(INSTALL_ROOT_BINARIES)/software/yocto_linux_mainline_qspi/console-image-minimal-$(KAS_MACHINE).rootfs.tar.gz \
	$(INSTALL_ROOT_BINARIES)/software/yocto_linux_mainline_qspi/console-image-minimal-$(KAS_MACHINE).rootfs.manifest \
	$(INSTALL_ROOT_BINARIES)/software/yocto_linux_mainline_qspi/console-image-minimal-$(KAS_MACHINE).rootfs.jffs2 \
...
# Roll-your-own Linux Build
###############################################################################
RYO_IMAGE_DIR := software/ryo_linux/build_output

SW_RYO_LINUX_SD_TARGET := software-ryo_linux_sd
ALL_SW_TARGET_STEM_NAMES += $(SW_RYO_LINUX_SD_TARGET)

.PHONY: $(SW_RYO_LINUX_SD_TARGET)-clean-sw
$(SW_RYO_LINUX_SD_TARGET)-clean-sw:
	cd software/ryo_linux && ./clean_build.sh

.PHONY: $(SW_RYO_LINUX_SD_TARGET)-build-sw
$(SW_RYO_LINUX_SD_TARGET)-build-sw: $(RYO_IMAGE_DIR)/sdcard.img

$(RYO_IMAGE_DIR)/sdcard.img:
	cd software/ryo_linux && ./ryo_linux_sd.sh

.PHONY: $(SW_RYO_LINUX_SD_TARGET)-install-sw
