...
module tsn_cfg2 (
    ...
    output wire         fpga_emac1_mdc,
    inout  wire         fpga_emac1_mdio,
    //
    // External FPGA Reset
    ...
    // Drive FPGA EMAC1 MDIO signal
    wire emac1_mdi;
    wire emac1_mdo;
    wire emac1_mdoe;
    assign fpga_emac1_mdio = emac1_mdoe ? emac1_mdo : 1'bz;
    assign emac1_mdi = fpga_emac1_mdio;

    // RGMII TX clock DDR GPIO
    wire rgmii_tx_clk;
    ddr_gpio ddr_gpio_inst (
        .ck     (rgmii_tx_clk),
        .din    (2'b01),
        .pad_out(fpga_rgmii_tx_clk)
    );

    // TSN Config2 system top module
    tsn_cfg2_top u_tsn_cfg2_top (
        // Board PLL reference clock
        ...
        //
        // FPGA RGMII I/O Interface
        .fpga_phy_rgmii_rgmii_rx_clk          (fpga_rgmii_rx_clk),
        .fpga_phy_rgmii_rgmii_rxd             (fpga_rgmii_rxd),
        .fpga_phy_rgmii_rgmii_rx_ctl          (fpga_rgmii_rx_ctl),
        .fpga_phy_rgmii_rgmii_tx_clk          (rgmii_tx_clk),
        .fpga_phy_rgmii_rgmii_txd             (fpga_rgmii_txd),
        .fpga_phy_rgmii_rgmii_tx_ctl          (fpga_rgmii_tx_ctl),
        .emac1_mdio_mac_mdc                   (fpga_emac1_mdc),
