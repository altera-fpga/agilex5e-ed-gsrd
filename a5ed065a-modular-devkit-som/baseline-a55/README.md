# HPS Baseline-A55 System Example Design for Agilex 5 FPGA E-Series 065A Modular Development Kit

Baseline Golden Hardware Reference Design (GHRD) for Agilex 5 FPGA E-Series 065A Modular Development Kit.
...
- **Development Kit**: Agilex 5 FPGA E-Series 065A Modular Development Kit MK-A5E065AB32AEA
- **Device Part**: A5ED065AB32AE1V
- **Category**: HPS
- **Source**: Quartus Prime Pro
- **URL**: https://www.github.com/altera-fpga/agilex5e-ed-gsrd
- **Design Package**: a5ed065a-modular-devkit-som-baseline-a55.zip
...
**URL**: https://github.com/altera-fpga/agilex5e-ed-gsrd/blob/main/a5ed065a-modular-devkit-som/baseline-a55/README.md
...
#### Notes
- There are 2 user DIP switch inputs, 2 user push-button inputs and 1 LED outputs that is connected to fpga pins on Agilex 5 FPGA E-Series 065A Modular Development Kit.
