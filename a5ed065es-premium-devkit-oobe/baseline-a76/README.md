# HPS Baseline-A76 System Example Design with HPS Expansion Board for Agilex 5 FPGA E-Series 065B Premium Development Kit (ES)

HPS Baseline-A76 System Example Design for Agilex 5 FPGA E-Series 065B Premium Development Kit with Out of Box Experience (OOBE) daughter card, which is also known as HPS Enablement Expansion Board.
...
- **Design Package**: a5ed065es-premium-devkit-oobe-baseline-a76.zip
...
**URL**: https://github.com/altera-fpga/agilex5e-ed-gsrd/blob/main/a5ed065es-premium-devkit-oobe/baseline-a76/README.md


## GHRD Overview
![Block Diagram Baseline-A76 GHRD Overview](../../images/oobe-baseline-overview.png)
...
```bash
make baseline_a76-install-core-rbf
```
