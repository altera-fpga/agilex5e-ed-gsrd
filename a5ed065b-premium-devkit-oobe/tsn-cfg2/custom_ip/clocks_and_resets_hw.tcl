...
add_interface_port h2f_reset_in h2f_reset reset Input 1
...
set_interface_property system_clock clockRate 100000000
...
add_interface_port system_clock sys_clk_100 clk Output 1
...
add_interface_port system_reset_n sys_clk_100_reset_n reset_n Output 1
...
set_interface_property pll_locked IPXACT_REGISTER_MAP_VARIABLES ""
set_interface_property pll_locked SV_INTERFACE_TYPE ""
set_interface_property pll_locked SV_INTERFACE_MODPORT_TYPE ""

add_interface_port pll_locked pll_locked export Output 1


#
# connection point pll_clk_25
#
add_interface pll_clk_25 clock start
set_interface_property pll_clk_25 associatedDirectClock ""
set_interface_property pll_clk_25 ENABLED true
set_interface_property pll_clk_25 EXPORT_OF ""
set_interface_property pll_clk_25 PORT_NAME_MAP ""
set_interface_property pll_clk_25 CMSIS_SVD_VARIABLES ""
set_interface_property pll_clk_25 SVD_ADDRESS_GROUP ""
set_interface_property pll_clk_25 IPXACT_REGISTER_MAP_VARIABLES ""
set_interface_property pll_clk_25 SV_INTERFACE_TYPE ""
set_interface_property pll_clk_25 SV_INTERFACE_MODPORT_TYPE ""

add_interface_port pll_clk_25 pll_clk_25 clk Output 1


#
# connection point pll_clk_2_5
#
add_interface pll_clk_2_5 clock start
set_interface_property pll_clk_2_5 associatedDirectClock ""
set_interface_property pll_clk_2_5 ENABLED true
set_interface_property pll_clk_2_5 EXPORT_OF ""
set_interface_property pll_clk_2_5 PORT_NAME_MAP ""
set_interface_property pll_clk_2_5 CMSIS_SVD_VARIABLES ""
set_interface_property pll_clk_2_5 SVD_ADDRESS_GROUP ""
set_interface_property pll_clk_2_5 IPXACT_REGISTER_MAP_VARIABLES ""
set_interface_property pll_clk_2_5 SV_INTERFACE_TYPE ""
set_interface_property pll_clk_2_5 SV_INTERFACE_MODPORT_TYPE ""

add_interface_port pll_clk_2_5 pll_clk_2_5 clk Output 1
