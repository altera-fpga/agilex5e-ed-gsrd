...
- Copy fpga bitstream i.e ```tsn_cfg2_hps_debug.core.rbf``` at ```meta-custom/recipes-fpga/fpga-bitstream/files/```
...
FPGA options
 ...
 (tsn_cfg2_hps_debug.core.rbf) Core RBF configuration bitstream filename
```
...
- During the build, the tsn_cfg2_hps_debug.core.rbf file is installed to:
