...
module baseline_a55 (
    ...
    //
    // Switches and LEDs
    output wire [1-1:0] fpga_user_leds,
    input  wire [2-1:0] fpga_user_switches,
    ...
    assign fpga_push_buttons = {
        {(BUTTONS_PIO_WIDTH - $bits(fpga_user_push_buttons)) {1'b0}}, fpga_user_push_buttons
    };
    ...
    assign fpga_user_leds = fpga_leds[0];
